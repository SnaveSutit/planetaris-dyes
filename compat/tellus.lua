...
if data.raw.technology["planetaris-primary-dyes"] then
            ...
            table.insert(data.raw.technology["planetaris-primary-dyes"].unit.ingredients, {"planetaris-bioengineering-science-pack", 1})
            table.insert(data.raw.technology["planetaris-primary-dyes"].prerequisites, "planetaris-bioengineering-science-pack")
end
...
},
{
    ...
    if data.raw.technology["planetaris-secondary-dyes"] then
            ...
            table.insert(data.raw.technology["planetaris-secondary-dyes"].unit.ingredients, {"planetaris-bioengineering-science-pack", 1})
            table.insert(data.raw.technology["planetaris-secondary-dyes"].unit.ingredients, {"planetaris-pathological-science-pack", 1})
            table.insert(data.raw.technology["planetaris-secondary-dyes"].prerequisites, "planetaris-pathological-science-pack")
    end
